          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative">
              ...
              >
                ...
                <span className="hidden sm:inline">Acesso ADM</span>
              ...
              {showDemoMenu && (
                ...
                >
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-xs font-semibold text-slate-200 group-hover:text-white">Novo Cliente</p>
                      <p className="text-[10px] text-slate-400 truncate">Cadastre seu nome e telefone</p>
                    </div>
                  </button>

                  <div className="mt-2 pt-2 border-t border-slate-800 px-2 py-1 flex items-center justify-between text-[10px] text-slate-400">
