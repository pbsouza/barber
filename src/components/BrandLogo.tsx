...
export const BrandLogo: React.FC<BrandLogoProps> = ({
  ...
  const [imgSrc, setImgSrc] = useState<string>(emblemImg);
  const [logoSrc, setLogoSrc] = useState<string>(fullLogoImg);

  // Icon only: Real emblem image of Lucas Hoffmann Barber
  if (variant === 'icon') {
    return (
  ...
  // Compact header logo: Real emblem image + crisp luxury typography
  if (variant === 'compact') {
    return (
  ...
  // Full Hero & Badge: Ornate barbershop real brand image
  return (
